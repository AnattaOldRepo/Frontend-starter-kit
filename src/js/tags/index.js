...
var form = document.querySelector('#tags-form');
    console.log(form);
    var foo = new Tags(form.tags, {
        join: ', ',
        values: true, // is equal to `foo.input.value.split(foo.config.join)`
        update: function(tags) {
            console.log(tags); // check the added tags on every update event
        }
    });
    console.log(foo);
    foo.beautify();